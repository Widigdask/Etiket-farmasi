...
- Login, pendaftaran akun, logout, reset password mandiri, dan lockout lokal.
...
| `css/auth.css` | Tampilan login, daftar akun, reset password, lockout, dan style kompatibilitas lama. |
