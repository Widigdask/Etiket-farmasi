 ...
 * Login, register, logout, session, password request
...
async function doRegister() {
  ...
  localStorage.setItem("tutorial_seen_" + newUser.username, "true");
  showToast("Pendaftaran berhasil. Membuka aplikasi...", "success");
  ...
  showAlert("register", "success", "Akun berhasil dibuat. Anda akan masuk ke aplikasi.");
  setTimeout(() => {
    window.location.href = "app.html";
  }, 700);
}
